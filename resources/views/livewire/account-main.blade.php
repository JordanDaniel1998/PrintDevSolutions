        ...
        <div class="flex flex-col w-11/12 mx-auto">
            <div class="flex flex-col gap-10 my-5" data-aos="fade-up" data-aos-offset="150">
                <div class="flex gap-2 text-text14 xl:text-text18 justify-start items-center">
                    ...
                    <button wire:click="showEditUser" class="font-bold font-inter text-[#111111]">Mi cuenta</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mb-8 md:mb-16">
        <div class="flex flex-col gap-12 md:flex-row lg:gap-28 w-full md:w-11/12 mx-auto">
                ...
                <div class="w-11/12 md:w-full mx-auto">
                    <div class=" flex flex-col gap-5">
                        ...
                        <div class="flex flex-col gap-4" data-aos="fade-up" data-aos-offset="150">
                            ...
                            <button wire:click="showEditUser"
                                class="font-bold font-inter text-text16 md:text-text18 flex justify-between items-center w-full md:w-80 {{ $view == 'edit-user' ? 'bg-[#0051FF] text-white' : 'text-[#565656]' }} transition-all duration-300 py-3 px-5">
                                Mi cuenta
                                <span>
                            ...
                            <button wire:click.prevent="showDirectionUser"
                                class="font-bold font-inter text-text16 md:text-text18 flex justify-between items-center w-full md:w-80 {{ $view == 'direction-user' ? 'bg-[#0051FF] text-white' : 'text-[#565656]' }} transition-all duration-300 py-3 px-5">
                                Dirección
                                <span>
                                    <svg width="20" height="20" viewBox="0 0 14 13" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button wire:click.prevent="showOrdersHistory"
                                class="font-bold font-inter text-text16 md:text-text18 flex justify-between items-center w-full md:w-80 {{ $view == 'historial-pedido' ? 'bg-[#0051FF] text-white' : 'text-[#565656]' }} transition-all duration-300 py-3 px-5">
                                Dirección
                                <span>
                                    <svg width="20" height="20" viewBox="0 0 14 13" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="basis-7/12 w-11/12 md:w-full mx-auto" data-aos="fade-up" data-aos-offset="150">
                ...
                @elseif ($view == 'direction-user')
                    <livewire:direction-user />
                @elseif ($view == 'historial-pedido')
                    <livewire:historial-pedido />
                @endif
...
{{-- <div>
    <button wire:click.prevent="$set('view', 'edit-user')"
        class="font-bold font-inter text-text16 md:text-text18 text-gray-800">
        Mi cuenta
    </button>
    <button wire:click.prevent="$set('view', 'direction-user')"
        class="font-bold font-inter text-text16 md:text-text18 text-[#565656]">
        Direccións
    </button>
