    ...
    <div class="modal__body">
        <div class="modal__list">
            @foreach ($carts as $cart)
                <div class="flex justify-between border-b-[1px] pb-5 gap-3">
                    <div class="flex justify-center items-center gap-2">
                        <div class="rounded-md p-2">
                            <a href="{{ route('productstoUser.index', $cart['id']) }}">
                                <img src="{{ asset('storage/uploads/' . $cart['image']) }}" alt="producto" class="size-24 object-cover" />
                            </a>
                        </div>
                    ...
                    <div class="flex flex-col justify-start py-2 gap-5 items-center pr-2">
                        <p class="font-inter font-bold text-[14px] md:text-text18 text-[#151515] flex gap-2 justify-start items-center">
                            S/
    ...
    <div class="modal__footer">
        <div class="flex flex-col gap-2 pt-36">
            <div class="text-[#141718] font-inter font-medium text-[20px] flex justify-between items-center">
                ...
                <p>S/ {{number_format( $subTotal, 2) }}</p>
            </div>
            <div>
