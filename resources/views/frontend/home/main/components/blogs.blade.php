        ...
        <div class="flex flex-col gap-10">
            <div class="flex flex-col justify-center gap-3 md:flex-row md:justify-between md:items-center">
                <div class="flex flex-col gap-5 basis-8/12">
                    ...
                    <p class="text-[#565656] text-text18 md:text-text22 font-inter font-normal">Explora los últimos artículos y novedades en el mundo de la tecnología. Mantente actualizado con las tendencias, tutoriales y noticias que están moldeando el futuro digital.</p>
                </div>
