    ...
    <table role="presentation"
      ...
      ">
        <tr>
            ...
            ">
                    <tr>
                        <td align="center" style="padding: 40px 0 30px 0; background: #0051ff">
                            <img src="./image 38.png" alt="dsads" style="height: auto; display: block" />
                        </td>
                    </tr>
                    <tr>
                                    ...
                                    <td style="padding: 0 0 36px 0; color: #153643">
                                        ...
                                        <p
                                            style="
                                                ...
                                                text-align: center;
                                                ">
                                            Hola, en breve estaremos comunicandonos contigo.
                                        </p>
                                        <p
                                            style="
                                                margin: 0;
                    ...
                    <tr>
                        <td style="padding: 30px; background: #001232">
                            <table role="presentation"
                                style="
                                    width: 100%;
                                    border-collapse: collapse;
