    ...
    <section>
        <div class="flex flex-col gap-5 lg:pt-10">
            ...
            <div class="p-10 shadow-md border">
                <table id="categoriesBlog" class="table table-striped" style="width:100%">
                    <thead>
                        <tr>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var categoriesBlog = $('#categoriesBlog').DataTable({
                responsive: true,
                ...
                ajax: {
                    url: '{{ route('categoriesOfArticles.getData') }}',
                    type: 'GET',
            ...
            $('#formCategorieRegister').submit(function(e) {
                ...
                $.ajax({
                    url: '{{ route('categoriesOfArticles.store') }}',
                    method: 'POST',
                    headers: {
            ...
            $('#categoriesBlog').on('click', '.btn-edit', function() {
            ...
            $('#categoriesBlog').on('click', '.btn-delete', async function() {
