...
@section('contenido')
    ...
    <section class="shadow-md border-2 px-3 md:!px-10 py-10">
        ...
        <form action="{{ route('articles.store') }}" method="POST" class="flex flex-col gap-10" novalidate
            enctype="multipart/form-data">
            @csrf
            <div class="flex flex-col gap-4">
                <div class="flex flex-col gap-2 w-full">
                    <x-input-label-dashboard for="title" :value="__('Título')" />
                    <x-input-text-dashboard id="title" type="text" required autocomplete="Título del blog"
                        placeholder="Título del blog" name="title" :value="old('title')" />
                    @error('title')
                ...
                <div class="flex flex-col gap-2 w-full">
                    ...
                    <x-input-text-dashboard id="subTitle" type="text" required autocomplete="Subtítulo del producto"
                        placeholder="Subtítulo del producto" name="subTitle" :value="old('subTitle')" />
                    @error('subTitle')
                        <span class="text-red-500 font-medium">
                ...
                <div class="flex flex-col gap-2 w-full">
                    ...
                    <x-text-area-dashboard id="keywords" type="text" required autocomplete="Datos importantes"
                        placeholder="Escribe alguna información relevante del blog" name="keywords" :value="old('keywords')"
                        rows="2" />
                    @error('keywords')
                        <span class="text-red-500 font-medium">
                ...
                <div class="flex flex-col gap-2 w-full">
                    ...
                    <x-text-area-dashboard id="description_short" type="text" required
                        ...
                        name="description_short" :value="old('description_short')" rows="2" />
